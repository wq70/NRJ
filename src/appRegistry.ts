...
export const appRegistry: AppRegistryItem[] = [
  ...
  { id: 'couple_space', name: '情侣空间', icon: '<span class="text-icon">空</span>', color: '#ffffff', available: true, allowCustomFont: true },
  { id: 'forum', name: '论坛', icon: '<span class="text-icon">论</span>', color: '#ffffff', available: true, allowCustomFont: true },
  { id: 'live', name: '直播', icon: '<span class="text-icon">播</span>', color: '#ffffff', available: true, allowCustomFont: true },
  ...
  { id: 'watch_together', name: '共赏空间', icon: '<span class="text-icon">赏</span>', color: '#ffffff', available: true, allowCustomFont: true },
  { id: 'timebox', name: '时间盒', icon: '<span class="text-icon">盒</span>', color: '#ffffff', available: true, allowCustomFont: true },
  { id: 'mcp', name: 'MCP', icon: '<span class="text-icon">M</span>', color: '#ffffff', available: true, allowCustomFont: true },
  { id: 'text_game', name: '文游', icon: '<span class="text-icon">游</span>', color: '#ffffff', available: true, allowCustomFont: true },
  ...
  { id: 'game', name: '游戏', icon: '<span class="text-icon">游</span>', color: '#ffffff', available: true, allowCustomFont: true },
